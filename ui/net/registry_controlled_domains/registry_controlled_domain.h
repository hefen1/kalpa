...
enum UI_EXPORT PrivateRegistryFilter {
...
// foobar.baz).
enum UI_EXPORT UnknownRegistryFilter {
...
UI_EXPORT std::string GetDomainAndRegistry(const GURL& gurl,
                                            PrivateRegistryFilter filter);

// Like the GURL version, but takes a host (which is canonicalized internally)
// instead of a full GURL.
UI_EXPORT std::string GetDomainAndRegistry(const std::string& host,
                                            PrivateRegistryFilter filter);
...
UI_EXPORT bool SameDomainOrHost(const GURL& gurl1, const GURL& gurl2,
                                 PrivateRegistryFilter filter);
...
//                                                         bar)
UI_EXPORT size_t GetRegistryLength(const GURL& gurl,
                                    UnknownRegistryFilter unknown_filter,
                                    PrivateRegistryFilter private_filter);

// Like the GURL version, but takes a host (which is canonicalized internally)
// instead of a full GURL.
UI_EXPORT size_t GetRegistryLength(const std::string& host,
                                    UnknownRegistryFilter unknown_filter,
                                    PrivateRegistryFilter private_filter);
