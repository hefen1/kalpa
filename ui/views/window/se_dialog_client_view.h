...
#ifndef UI_VIEWS_WINDOW_SE_DIALOG_CLIENT_VIEW_H_
#define UI_VIEWS_WINDOW_SE_DIALOG_CLIENT_VIEW_H_
...
// SeDialogClientView provides adornments for a dialog's content view, including
...
//   | [      Footnote View       ] |
//   +------------------------------+
class VIEWS_EXPORT SeDialogClientView : public ClientView,
                                      public ButtonListener,
                                      public FocusChangeListener {
 public:
  SeDialogClientView(Widget* widget, View* contents_view);
  virtual ~SeDialogClientView();
  ...
  ImageTextButton* ok_button() const { return ok_button_; }
  ImageTextButton* cancel_button() const { return cancel_button_; }
  ...
  virtual SeDialogClientView* AsSeDialogClientView() OVERRIDE;
  virtual const SeDialogClientView* AsSeDialogClientView() const OVERRIDE;
 ...
 protected:
  // For testing.
  SeDialogClientView(View* contents_view);
 ...
 private:
  ...
  ImageTextButton* CreateDialogButton(ui::DialogButton type);

  // Update |button|'s text and enabled state according to the delegate's state.
  void UpdateButton(ImageTextButton* button, ui::DialogButton type);
  ...
  // The dialog buttons.
  ImageTextButton* ok_button_;
  ImageTextButton* cancel_button_;

  // The button that is currently default; may be NULL.
  ImageTextButton* default_button_;
  ...
  DISALLOW_COPY_AND_ASSIGN(SeDialogClientView);
};
