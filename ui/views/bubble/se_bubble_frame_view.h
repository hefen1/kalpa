...
#ifndef UI_VIEWS_BUBBLE_SE_BUBBLE_FRAME_VIEW_H_
#define UI_VIEWS_BUBBLE_SE_BUBBLE_FRAME_VIEW_H_
...
class VIEWS_EXPORT SeBubbleFrameView : public NonClientFrameView,
 ...
 public:
  ...
  explicit SeBubbleFrameView(const gfx::Insets& content_margins);
  virtual ~SeBubbleFrameView();
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(SeBubbleFrameView);
};
